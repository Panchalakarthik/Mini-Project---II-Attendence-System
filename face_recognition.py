...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(text="Welcome to Face Recognition Pannel",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=70)
        ...
        std_b1_1 = Button(command=self.face_recog,text="Face Detector",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
